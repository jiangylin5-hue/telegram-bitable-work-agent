...
| G3 Step 1 — focused verification | completed locally | focused backend `19 passed`, frontend `5 files / 19 tests`, production build, migration downgrade/upgrade and smoke passed. |
