...
- Fresh frontend evidence after the final lifecycle repair: `npm.cmd test -- --run` passed `17` files / `87` tests and `npm.cmd run build` passed. Focused and full task reviews passed after the two lifecycle repairs. This evidence does not replace F2 end-to-end fixture coverage or actual 1440/1280/430/390 Browser QA.
