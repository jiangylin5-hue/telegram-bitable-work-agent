...
- This run does not claim all mobile negatives: mobile replay-after-reread and allowlisted invalid-feedback states were not rerun at 430/390, and the authorised disposable F2 PostgreSQL matrix and final requirement-by-requirement audit remain open. No runtime/API/schema/permission change was made in this evidence-only substage.
