...
| R6-06 | LLM multi-case robustness | Passed after skills connection: `summarize_basic`, `draft_update_status`, `hidden_field_guard`, `unsafe_commit_refusal`, `citations_required` | Five live cases are a smoke suite, not a statistical LLM routing/answer-quality evaluation | Expand labeled live prompts separately from the deterministic 118-case matcher corpus |
