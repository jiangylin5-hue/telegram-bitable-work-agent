...
- Status: implementation evidence reconciled; GW-A06 is locally complete and GW-A07 retains built-client terminal-lifecycle gaps below.
...
| GW-A06 | protected QueryClient cleanup and authoritative reread are exact | parser/query/App tests for 401/403/404/409/scope replacement | implemented-local — immediate 401/403, exact Base 404, explicit 409 field-policy reread and focus return are covered; delayed old-workspace role and field-policy mutations across `401/403/404/409` cannot deny or repopulate the replacement workspace. |
