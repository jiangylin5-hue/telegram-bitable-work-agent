...
- [ ] F1 remains limited to approved independent field types, generated keys and safe choice metadata; F2 has its separately approved bounded contract and detailed companion BDD/SDD/module/index. V1 Saved View Builder has a user-approved comprehensive design and a detailed implementation plan awaiting separate approval, but no V1 runtime behavior is accepted.
