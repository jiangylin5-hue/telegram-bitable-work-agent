...
- [ ] Cross-workspace/field-policy, independent persisted-audit-store and exhaustive client failure/supersession cases have remaining S6.1 acceptance gaps. Resolver locking/concurrent-revoke, mismatch zero-lookup and no-send inventory regressions have local evidence.
