...
- [ ] Cross-workspace/field-policy and exhaustive client failure/supersession cases have remaining S6.1 acceptance gaps. Resolver locking/concurrent-revoke, mismatch zero-lookup, persisted closed-audit and no-send inventory regressions have local evidence.
