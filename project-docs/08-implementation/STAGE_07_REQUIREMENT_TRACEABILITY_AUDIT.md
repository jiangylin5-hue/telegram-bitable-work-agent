...
| F2 relation/lookup Builder | Source §5; F2 Design; F2 Plan; F2 BDD/SDD/Work Surface/Complex Index | `partial-local` | User-approved design/plan; detailed F2 BDD/SDD/module/index; local commits `37b1e95` safe transport, `c3688da` atomic relation initializer and `cac3d57` bounded lookup initializer | Candidate picker, record write rechecks, lookup evaluator/guards, PostgreSQL, frontend and browser evidence are absent. No F2 acceptance or production claim. |
