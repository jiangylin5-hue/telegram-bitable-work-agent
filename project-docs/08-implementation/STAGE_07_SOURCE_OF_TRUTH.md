...
- Substage Delivery Update: Stage07 now uses the S0--S6 coherent-substage roadmap. S5 has approved TD005 and TD006 decision/design/BDD/SDD/module/index/plan packages plus local implementation evidence. TD007 Option A now has its decision/design/BDD/SDD/module/index/implementation package plus local test evidence. TD008 Option A has its approved local implementation, migration and evidence package; S6.1 failure-matrix reconciliation, S6.2 concurrency/logger depth and real Bot delivery/manual smoke remain independently gated. See [Substage Delivery Roadmap](STAGE_07_SUBSTAGE_DELIVERY_ROADMAP.md).
