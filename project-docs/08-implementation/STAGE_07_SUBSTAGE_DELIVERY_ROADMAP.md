...
| S5.2 | Digital employee management and work scope | manager-created Base-bound employee, fixed scope/action configuration, optional assigned-member eligibility and pause/resume lifecycle | proposed documentation package; no code | TD010 Option A; pending schema/API/permission behavior approval |
