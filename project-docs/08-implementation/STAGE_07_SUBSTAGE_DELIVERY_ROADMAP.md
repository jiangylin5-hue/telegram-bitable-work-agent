...
| S5.2 | Digital employee management and work scope | manager-created Base-bound employee, fixed scope/action configuration, optional assigned-member eligibility and pause/resume lifecycle | approved design and detailed plan awaiting implementation-plan review; no code | TD010 Option A; schema/API/permission boundary approved |
