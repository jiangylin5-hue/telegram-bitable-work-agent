...
| [S5 Draft And Digital Employee Hub Work Surface](modules/STAGE_07_DRAFT_EMPLOYEE_HUB_WORK_SURFACE.md) | bounded safe contacts, explicit context, invocation, field-filtered draft review and terminal receipt | TD005, existing Stage06 runtime/draft service, Record Detail rendering and protected query state |
| [S6.1 Telegram Identity And Deep-Link Work Surface](modules/STAGE_07_S6_TELEGRAM_IDENTITY_DEEP_LINK_WORK_SURFACE.md) | verified Mini App launch identity, opaque pointer resolution and authoritative App reread | TD007, Stage06 binding/member authorization, protected query state and Base/View/Record/Draft safe reads |
| [S6.2 Controlled Delivery And Smoke Work Surface](modules/STAGE_07_S6_CONTROLLED_DELIVERY_SMOKE_WORK_SURFACE.md) | proposed one-target restricted-test Worker handoff and sanitized real Telegram smoke | TD008, existing send confirmation/Outbox/Worker/Bot client, TD007 mint/resolver and explicit external authority |
...
S5 is `specified-awaiting-review`. Its proposed boundary is [Technical Decision 005](STAGE_07_TECHNICAL_DECISION_005_DRAFT_EMPLOYEE_HUB.md), [BDD](STAGE_07_DRAFT_EMPLOYEE_HUB_BDD_AND_ACCEPTANCE.md), [SDD](STAGE_07_DRAFT_EMPLOYEE_HUB_SDD.md), [work surface](modules/STAGE_07_DRAFT_EMPLOYEE_HUB_WORK_SURFACE.md) and [complex index](STAGE_07_DRAFT_EMPLOYEE_HUB_COMPLEX_FEATURE_INDEX.md). It deliberately excludes the broader Digital Employee Hub's publication, memory, knowledge and Telegram features.

S6.1 is `partial-local`: its [TD007](STAGE_07_TECHNICAL_DECISION_007_TELEGRAM_MINI_APP_IDENTITY_AND_DEEP_LINK.md), [BDD](STAGE_07_S6_TELEGRAM_IDENTITY_DEEP_LINK_BDD_AND_ACCEPTANCE.md), [SDD](STAGE_07_S6_TELEGRAM_IDENTITY_DEEP_LINK_SDD.md), [work surface](modules/STAGE_07_S6_TELEGRAM_IDENTITY_DEEP_LINK_WORK_SURFACE.md) and [complex index](STAGE_07_S6_TELEGRAM_IDENTITY_DEEP_LINK_COMPLEX_FEATURE_INDEX.md) cover verified identity and safe handoff only. S6.2 is a separate `proposed` package under [TD008](STAGE_07_TECHNICAL_DECISION_008_S6_CONTROLLED_DELIVERY_AND_SMOKE.md); its [BDD](STAGE_07_S6_CONTROLLED_DELIVERY_SMOKE_BDD_AND_ACCEPTANCE.md), [SDD](STAGE_07_S6_CONTROLLED_DELIVERY_SMOKE_SDD.md), [work surface](modules/STAGE_07_S6_CONTROLLED_DELIVERY_SMOKE_WORK_SURFACE.md) and [complex index](STAGE_07_S6_CONTROLLED_DELIVERY_SMOKE_COMPLEX_FEATURE_INDEX.md) authorize no code, Bot setup or send before separate approval and per-environment authority.
