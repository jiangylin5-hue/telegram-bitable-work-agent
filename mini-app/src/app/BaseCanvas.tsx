...
export function BaseCanvas({ base, tables, views, table, view, schema, records, presentation, loadingMore, loadMoreError, onBack, onOpenRecord, onSelectTable, onSelectView, onLoadMore, onCreateRecord, canManageSchema = false, onCreateTable, onCreateField }: BaseCanvasProps) {
