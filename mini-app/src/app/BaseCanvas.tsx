...
type BaseCanvasProps = { base: BaseSummary; tables: PlatformTable[]; views: ViewSummary[]; table: PlatformTable | null; view: ViewSummary | null; schema: TableSchema | null; records: ViewRecords | null; presentation: ViewPresentation | null; loadingMore?: boolean; loadMoreError?: boolean; onBack: () => void; onOpenRecord: (recordId: string) => void; onSelectView: (viewId: string) => void; onLoadMore?: (cursor: string) => void; onCreateRecord?: () => void }

export function BaseCanvas({ base, tables: _tables, views, table, view, schema, records, presentation, loadingMore, loadMoreError, onBack, onOpenRecord, onSelectView, onLoadMore, onCreateRecord }: BaseCanvasProps) {
