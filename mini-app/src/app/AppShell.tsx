...
type AppShellProps = { workspace: Workspace; workspaces: Workspace[]; onWorkspaceChange: (workspaceId: string) => void; onOpenGovernance?: (trigger: HTMLElement) => void; children: React.ReactNode }
...
export function AppShell({ workspace, workspaces, onWorkspaceChange, onOpenGovernance, children }: AppShellProps) {
