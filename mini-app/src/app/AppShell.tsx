...
type AppShellProps = { workspace: Workspace; workspaces: Workspace[]; onWorkspaceChange: (workspaceId: string) => void; activeRoute: AppShellRoute; onNavigate: (route: AppShellRoute) => void; onOpenDraftHub?: (trigger: HTMLElement) => void; onOpenTeamBot?: (trigger: HTMLElement) => void; onOpenCollaboration?: (trigger: HTMLElement) => void; onOpenMemory?: (trigger: HTMLElement) => void; onOpenGovernance?: (trigger: HTMLElement) => void; telegramState?: TelegramFullscreenState | null; onOpenBrowser?: () => void; children: React.ReactNode }
...
export function AppShell({ workspace, workspaces, onWorkspaceChange, activeRoute, onNavigate, onOpenDraftHub, onOpenTeamBot, onOpenCollaboration, onOpenMemory, onOpenGovernance, telegramState, onOpenBrowser, children }: AppShellProps) {
