  ...
  return <div className="draft-hub-backdrop" role="presentation">
    <aside className="draft-hub" aria-label="数字员工与草稿" aria-modal="true" role="dialog">
      ...
      <div className="draft-hub-columns">
        ...
        <section aria-label="当前上下文和草稿详情" className="draft-hub-section"><header><p>CONTEXT</p><h3>当前上下文与草稿</h3></header>
          ...
          <header className="draft-hub-subheading"><p>DRAFT</p><h3>待确认变更</h3></header>
